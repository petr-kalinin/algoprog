...
export default class Checkins extends React.Component
    ...
    render: () ->
        ...
        <div>
            ...
            <p>
            Новичкам (кто не решил в курсе ни одной задачи) записываться не надо,
            надо просто приходить к 14.00. Или можете начать заниматься сдавать задачи заочно — 
                ...
                <div>
                    ...
                    if wasme[0] or wasme[1]
                        ...
                        <Alert bsStyle="danger">
                            ...
                            Или просто придти на занятие для новичков в 14.00 без записи, см. правила выше.
                        </Alert>
                    }
                </div>
            }
