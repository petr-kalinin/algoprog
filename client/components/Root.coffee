                    ...
                    <Tab.Content animation>
                        <Tab.Pane eventKey="school">
                            ...
                            <p className="lead">
                                ...
                                Вы можете заниматься заочно; также для учеников лицея 40 г. Н. Новгорода проходят очные занятия.
                                Занятия для лицея 40 бесплатные,
                                для остальных <Link to="/pay">платные</Link> (для нижегородских школьников не из лицея 40 есть бесплатный вариант).
                            </p>
                            <p className="lead">
