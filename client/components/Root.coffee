...
Inner = (props) ->
    <div>
                    ...
                    <Tab.Content animation>
                        <Tab.Pane eventKey="school">
                            ...
                            <p className="lead">
                                ...
                                для школьников младше 9 класса тоже,
        ...
        <p className="lead">
            Темы разбиты по уровням по возрастанию сложности: от основ синтаксиса до продвинутых алгоритмов.
            По большинству тем есть теоретические материалы (статьи, советы, видеолекции) и задачи.
        </p>
        <p className="lead">
            Вы изучаете теорию и решаете задачи на своем любимом языке программирования.
            Задачи отправляете на сайт и они автоматически проверяются.
        </p>
        <p className="lead">
            Через минуту вы узнаете, правильное решение у вас или неправильное.
            Если правильное — двигаетесь дальше; если неправильное, думаете, как это исправить.
        </p>
        <p className="lead">
            Все неправильные решения я вижу и могу вам подсказать, в чем у вас ошибка.
            Все правильные решения я тоже вижу и просматриваю глазами — насколько оптимально они написаны.
        </p>
        <p className="lead">
            Если решение написано достаточно хорошо, я его засчитываю.
            Могу еще написать небольшие комментарии по вашему коду.
        </p>
        <p className="lead">
            Если решение написано не очень хорошо, я его не засчитываю — «игнорирую».
            К игнорированным решениям я пишу комментарий, и вам надо будет переделать решение.
        </p>
        <p className="lead">
            Когда ваше решение зачтено, вы получаете доступ к «лучшим решениям»,
            чтобы видеть, как эту задачу решали другие ученики.
        </p>
    </div>
