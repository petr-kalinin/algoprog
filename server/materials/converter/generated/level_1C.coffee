...
topic_15985 = () ->
    return topic("1В: Продвинутые задачи на условный оператор: в них запрещено пользоваться циклами и массивами", "1В: Продвинутые задачи на условный оператор: в них запрещено пользоваться циклами и массивами", [
        problem(297),
        problem(255),
        problem(258),
        problem(38),
...
module17396 = () ->
    page("Разбор задачи \"Строки в книге\" (читать только тем, кто ее решил!)", """
...
module15986 = () ->
    page("Разбор задачи про Франциска Ксавьера (читать только тем, кто решил саму задачу!)", """
...
topic_module_15982_0 = () ->
    return topic("Основы тестирования задач (без контеста)", null, [
        label("<a href=\"http://notes.algoprog.ru/testing/06_testing_main.html\">Теория по тестированию задач</a>. Вы там многое не поймете (особенно в примерах и в продвинутых методиках тестирования), но поймите хотя бы основы. в будущем, на более высоких уровнях, возвращайтесь к этому тексту."),
    ])

topic_15987 = () ->
    return topic("1В: Продвинутые задачи на циклы: в них запрещается пользоваться массивами", "1В: Продвинутые задачи на циклы: в них запрещается пользоваться массивами", [
        problem(227),
        problem(228),
        problem(3072),
        problem(3077),
...
topic_15989 = () ->
    return topic("1В: Продвинутые задачи на строки", "1В: Продвинутые задачи на строки", [
        problem(107),
        problem(109),
        problem(112),
        problem(111),
...
topic_15984 = () ->
    return topic("1В: Продвинутые задачи на массивы", "1В: Продвинутые задачи на массивы", [
        problem(1456),
        problem(1228),
        problem(201),
        problem(1568),
...
topic_15988 = () ->
    return topic("1В: Продвинутые задачи на вещественные числа", "1В: Продвинутые задачи на вещественные числа", [
        problem(3609),
        problem(3613),
        problem(3614),
        problem(3622),
...
module25368 = () ->
    page("Про \"странные числа\" в коде", """
