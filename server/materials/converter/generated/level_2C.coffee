...
topic_16064 = () ->
    return topic("2В: Продвинутые задачи на НОД", "2В: Продвинутые задачи на НОД", [
        problem(1465),
        problem(668),
        problem(1422),
        problem(1346),
...
topic_16067 = () ->
    return topic("2В: Продвинутые задачи на ДП", "2В: Продвинутые задачи на ДП", [
        problem(2998),
        problem(2999),
        problem(210),
        problem(2963),
...
topic_16066 = () ->
    return topic("2В: Продвинутые задачи на квадратичные сортировки И на стек-очередь-дек", "2В: Продвинутые задачи на квадратичные сортировки И на стек-очередь-дек", [
        problem(720),
        problem(1137),
        problem(111628),
        problem(51),
...
topic_16065 = () ->
    return topic("2В: *Продвинутые задачи на рекурсивный перебор", "2В: *Продвинутые задачи на рекурсивный перебор", [
        problem(157),
        problem(1680),
        problem(2776),
        problem(3879),
...
topic_16070 = () ->
    return topic("2В: Дополнительные задачи на разные темы - 2", "2В: Дополнительные задачи на разные темы - 2", [
        problem(422),
        problem(492),
        problem(111702),
        problem(1441),
...
topic_16069 = () ->
    return topic("2В: Дополнительные задачи на разные темы", "2В: Дополнительные задачи на разные темы", [
        problem(1037),
        problem(52),
        problem(1129),
        problem(1758),
...
topic_16068 = () ->
    return topic("2В: Продвинутые задачи на множители", "2В: Продвинутые задачи на множители", [
        problem(152),
        problem(584),
        problem(1009),
    ])
