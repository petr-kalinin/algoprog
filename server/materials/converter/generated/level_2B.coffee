...
topic16044 = () ->
    return topic("Простые числа и разложение на множители", "2Б: Задачи на множители", [
        label("<h4>Простые числа и разложение на множители</h4>"),
...
topic16038 = () ->
    return topic("Основы динамического программирования", "2Б: Простые задачи на ДП", [
        label("<h4>Основы динамического программирования</h4>"),
...
export default level_2B = () ->
    return level("2Б", [
        ...
        label("<h4>Сложность алгоритмов (без контеста)</h4>"),
