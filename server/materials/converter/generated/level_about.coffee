...
reg_about = () ->
    page("Про областную олимпиаду", """
        ...
        <p>Возможно, со временем я добавлю сюда разбор районной олимпиады.</p></div>
    """)
...
module16024_13 = () ->
    page("Информация про школу, читать всем!", """
