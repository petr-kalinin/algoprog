...
topic16307 = () ->
    return topic("Системы счисления. Двоичная система счисления.", "3Б: Задачи на системы счисления", [
        label("<h4>Системы счисления. Двоичная система счисления.</h4>"),
        label("Теории тут пока нет, можете поискать в интернете (я нашел <a href=\"https://ru.wikibooks.org/wiki/%D0%A1%D0%B8%D1%81%D1%82%D0%B5%D0%BC%D1%8B_%D1%81%D1%87%D0%B8%D1%81%D0%BB%D0%B5%D0%BD%D0%B8%D1%8F\">раз</a>, <a href=\"http://habrahabr.ru/post/124395/\">два</a>). Вам нужно понимание того, как работают позиционные системы счисления, и как переводить числа из одной системы в другую."),
        problem(117),
        problem(344),
        problem(47),
        problem(1367),
...
topic16372 = () ->
    return topic("Основы поиска в глубину", "3Б: Задачи на простой поиск в глубину", [
        label("<h4>Основы поиска в глубину</h4>"),
