...
topic16576 = () ->
    return topic("Логарифмические сортировки", "4А: Задачи на логарифмические сортировки", [
        label("<h4>Логарифмические сортировки</h4>"),
        module16475(),
        problem(1442),
        problem(766),
        problem(1418),
...
export default level_4A = () ->
    return level("4А", [
        ...
        topic16578(),
        topic16617(),
        label("<h4>Хранение графов списками смежности</h4>"),
        module16619(),
