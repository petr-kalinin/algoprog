...
topic16282 = () ->
    return topic("Бинарный поиск (поиск делением пополам)", "3А: Задачи на бинарный поиск", [
        label("<h4>Бинарный поиск (поиск делением пополам)</h4>"),
