...
topic16009 = () ->
    return topic("НОД, алгоритм Евклида", "2А: Задачи на НОД", [
        label("<h4>НОД, алгоритм Евклида</h4>"),
...
topic16020 = () ->
    return topic("Квадратичные сортировки", "2А: Задачи на квадратичные сортировки", [
        label("<h4>Квадратичные сортировки</h4>"),
...
export default level_2A = () ->
    return level("2А", [
        ...
        label("<h4>*Работа с файлами (без контеста)</h4>"),
        module24341(),
        label("<h4>*Функции (без контеста)</h4>\n<p>Теории тут нет, прочитайте в книжке или прослушайте на занятии.</p>"),
        topic16009(),
        topic16017(),
        topic16020(),
        topic25199(),
