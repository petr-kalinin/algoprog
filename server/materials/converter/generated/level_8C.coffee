...
topic_26208 = () ->
    return topic("8В: Дополнительные задачи на разные темы - 2", "8В: Дополнительные задачи на разные темы - 2", [
        problem(571),
        problem(112571),
        problem(1109),
        problem(455),
...
topic_26207 = () ->
    return topic("8В: Дополнительные задачи на разные темы - 1", "8В: Дополнительные задачи на разные темы - 1", [
        problem(11),
        problem(488),
        problem(111757),
        problem(2786),
