...
raion_olympiad = () ->
    page("Про районную/городскую олимпиаду", String.raw"""
        ...
        <p>Последние пять года задачи районной олимпиады составляет другое жюри, поэтому в первую очередь смотрите на задачи последних 5 лет, а не более старые.</p>
