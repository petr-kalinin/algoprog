...
sis = () ->
    page("Про Летнюю компьютерную школу", String.raw"""
        ...
        <p>Правда, есть проблема: участие в ЛКШ платное (ЛКШ проводится группой инициативных преподавателей и не имеет государственной поддержки), стоимость участия (19 дней: проживание, питание, занятия) будет предварительно 60 тыс. рублей.</p>
