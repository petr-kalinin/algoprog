...
tshirts = () ->
    page("Про футболки", String.raw"""
        ...
        <li>Достижение уровня 5В — TBA*</li>
        <li>Достижение уровня 7В — TBA*</li>
        <li>Достижение уровня 9В — TBA*</li>
        <li>Достижение уровня 11В — TBA*</li>
        </ul>
        <p>(TBA — футболки на данный момент не готовы, будут позже)</p>
        ...
        не-нижегородским школьникам и не-школьникам). Нижегородцам я готов выдать футболки на занятии, не-нижегородцам готов отправить 
        транспортной компанией (СДЭК или Боксберри).</p>
        <p>Чтобы я выдал вам футболку, напишите заранее, чтобы я ее принес на занятие. Футболки есть в разных размерах, мужские и женские. Пишите размер и крой.
        Если нужный размер/крой закончился, я вам предложу подождать — так или иначе я нужную футболку сделаю, но, возможно, не сразу, а в течение нескольких месяцев,
        до полугода. Или можете попросить другой размер.</p>
        ...
        Единственная особенность — вам футболки будут выдаваться не раньше декабря 2021 г. (чтобы при нехватке размеров футболки
        в первую очередь получили те, кто сейчас занимается).
