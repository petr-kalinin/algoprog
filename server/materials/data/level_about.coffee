...
work_with_site = () ->
    page("\nРабота с сайтом, отправка решений и просмотр моих комментариев", String.raw"""
        ...
        <li>Vы не ставим в конце программы пустой <code>input()</code> (или <code>getch();</code> в c++) или другую задержку работы. Это тоже не требуется; информация, выведенная на экран, все равно сохраняется и ее все равно можно посмотреть.</li>
