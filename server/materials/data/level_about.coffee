...
pay = () ->
    page("Стоимость и порядок оплаты занятий", String.raw"""
        ...
        <p>Формально вы считаетесь нижегородским школьником, если можете участвовать во Всероссийской олимпиаде школьников по информатике и имеете теоретическую возможность, пройдя школьный и муниципальный этапы, участвовать в региональном этапе ВсОШ в Нижегородской области (т.е. в Нижегородской областной олимпиаде школьников по информатике).</p>
