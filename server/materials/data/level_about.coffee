...
module20927_17 = () ->
    page("\nПро очные занятия для школьников", String.raw"""
        ...
        <p>То есть вы занимаетесь так же, как если бы вы занимались из дома. Единственное отличие очных занятий от занятий из дома состоит в том, что на очных занятиях присутствую я, и вы всегда можете меня спросить о чем-либо, и как правило я достаточно быстро отвечу. (Правда, учтите, что на очных занятиях помимо вас обычно еще присутствует с десяток школьников, у которых тоже есть свои вопросы :) ).</p>
        ...
        <p>В частности, поэтому расписание занятий у нас нестрогое. Вы можете опоздать на занятие, можете уйти раньше, можете пропустить часть занятий — всё на ваше усмотрение. Конечно, чем больше вы занимаетесь, тем лучше у вас, наверное, будут результаты, но я не требую какого-то строгого посещения занятий.</p>
        ...
        <p>Универсальный способ избежать пробему нехватки компьютеров — приносить свой ноутбук. Но <a href="/material/byod" onclick="window.goto('/material/byod')();return false;">см. отдельные правила про это</a>.</p></div>
    """, {id: "ochn"})
