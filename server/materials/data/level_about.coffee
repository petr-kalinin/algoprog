...
module20927_9 = () ->
    page("\nИнструкция для тех, кто здесь в первый раз (или \"Что надо сделать, чтобы начать заниматься?\")", String.raw"""
        ...
        <ol>
        <li>Во-первых, можно просто придти на специальное очное занятие для начинающих (информация о занятиях на страничке курса). Но можно начать (и продолжать) заниматься и дома, не дожидаясь очного занятия, можно и вообще на очные занятия не ходить. Все инструкции ниже идут как раз для случая, если вы хотите начать заниматься из дома.</li>
...
module20927_17 = () ->
    page("\nПро очные занятия для школьников", String.raw"""
        ...
        <p>В лицее 40 занятия проходят <b>по средам в КЦ</b>. Я обычно бываю в лицее с 15.00 до 17.00, иногда чуть позже. Аналогично, можно приходить и уходить в любое время, но см. ниже про нехватку компьютеров. Если вы хотите получить зачем за спецкурс, смотрите отдельные <a href="/material/in20946" onclick="window.goto('/material/in20946')();return false;">правила</a>.</p>
...
label_ochn = () ->
    label("""
        ...
        <li>Новичкам (кто не ходил ни разу и не решал задач заочно) 
            ...
            <b>22 сентября будет занятие для новичков, куда могут приходить все желающие лицеисты.</b> </li>
        ...
        <p>Занятия проходят по воскресеньям в нижегородском филиале ВШЭ по адресу ул. Костина, д. 2б (вход с пл. Горького, дверь справа от центра оперативной печати, проходите здание насквозь и во дворе вход в нужное здание). Точные аудитории будут указаны после первого занятия, 
        пока просто звоните.</p>
