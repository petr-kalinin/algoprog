...
reg_about = () ->
    page("Про областную (региональную) олимпиаду", String.raw"""<h1>Про областную (региональную) олимпиаду</h1>
        ...
        <p>Областная олимпиада по информатике (формально — региональный этап Всероссийской олимпиады) пройдет в два тура 20 и 22 января.</p>
        ...
        <p>Проходные баллы в этом году 310 баллов по всем классам.</p>
