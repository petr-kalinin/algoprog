...
label_ochn = () ->
    label("""
        ...
        <h3>ННГУ</h3>
        <p><b>Только для школьников</b></p>
        <p>Занятия ведет Илья Хлюстов (дважды финалист ICPC, член жюри Нижегородской городской олимпиады им. В.Д. Лелюха, ведущий инженер в Huawei NNRC).</p>
        <p>Занятия проходят по воскресеньям в 14.00 в 2 корпусе ННГУ, аудитории 110 и 114.</p>
        <p>Контакты: телеграм: <a href="https://t.me/Riladavin">@Riladavin</a>, вконтакте: <a href="https://vk.com/ikhlyustov">https://vk.com/ikhlyustov</a>.
        <hr>""")
