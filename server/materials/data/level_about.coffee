...
module20927_9 = () ->
    page("\nИнструкция для тех, кто здесь в первый раз (или \"Что надо сделать, чтобы начать заниматься?\")", String.raw"""
        ...
        <li><a href="/register" onclick="window.goto('/register')();return false;">Зарегистрируйтесь на сайте</a> (вас попросят еще зарегистрироваться на informatics.msk.ru). При регистрации укажите свое настоящее имя и правильный населенный пункт, чтобы я вас мог отличить среди других пользователей сайта.</li>
...
pay = () ->
    page("Стоимость и порядок оплаты занятий", String.raw"""
        ...
        <p>Для нижегородских школьников <b>занятия бесплатны</b>, и в обозримом будущем останутся бесплатными (т.к. мне проведение занятий оплачивает лицей 40).</p>
        ...
        <tbody>
        <tr><td></td><td>Активация до 01.01.2024</td><td>Активация 01.01.2024 и позже</td></tr>
        <tr><td>Нижегородские школьники (см. определение выше)</td><td>Бесплатно</td><td>Бесплатно</td></tr>
        <tr><td>Россия, 7 класс и младше</td><td>500 рублей в месяц</td><td>1000 рублей в месяц</td></tr>
        <tr><td>Россия, 8 класс</td><td>1000 рублей в месяц</td><td>1500 рублей в месяц</td></tr>
        <tr><td>Россия, 9 класс</td><td>1500 рублей в месяц</td><td>2000 рублей в месяц</td></tr>
        <tr><td>Россия, 10 класс</td><td>2000 рублей в месяц</td><td>2500 рублей в месяц</td></tr>
        <tr><td>Россия, 11 класс</td><td>2000 рублей в месяц</td><td>2500 рублей в месяц</td></tr>
        <tr><td>Не российские школьники</td><td>2000 рублей в месяц</td><td>2500 рублей в месяц</td></tr>
        <tr><td>Не школьники (студенты и старше)</td><td>2000 рублей в месяц</td><td>2500 рублей в месяц</td></tr>
        </tbody></table>
        ...
        <p>Должна работать оплата любыми картами большинства стран мира (как российскими, так и не-российскими). Если что-то не работает, напишите мне.
        ...
        <p>* Любые возвраты денег обсуждаются не позже 14 дней с момента окончания того периода, за который вы просите вернуть деньги. Если вы обращаетесь ко мне позже, я имею право отказать.</p>
...
koshp2022 = () ->
    page("Про командную олимпиаду", String.raw"""
        ...
        <p>Если вы пройдете на ВКОШП, то надо будет ехать в Санкт-Петербург в декабре,
        и не факт, что я смогу вас туда отвезти,  возможно, вам придется искать
        сопровождающего самостоятельно.</p>
        
        <p>Я не смогу, к сожалению, организовывать очные тренировки команд,
        но вы можете (и я настоятельно рекомендую) собираться самостоятельно
        и писать тренировки, я вам могу ставить дистанционные тренировки 
        по вашему запросу. Тренировки намного лучше писать, собравшись
        в каком-нибудь помещении вместе.</p></div>
    """, {id: "koshp"})
...
module20927_17 = () ->
    page("\nПро очные занятия для школьников", String.raw"""
        ...
        <p>Для учеников лицея 40 в течение учебного года проходят очные занятия по средам, на них можно ходить только ученикам лицея 40.</p>
        ...
        <p>Занятия проходят <b>по средам в КЦ</b>. Я обычно бываю в лицее с 15.00 до 17.00, иногда чуть позже. Можно приходить и уходить в любое время, но см. ниже про нехватку компьютеров.</p>
...
school_olympiad = () ->
    page("Про школьную олимпиаду", String.raw"""
        ...
        <li><b>(Только нижегородцы) Если информация, которую вам говорят в школе, противоречит написанному ниже (особенно если отличается дата проведения), срочно пишите/звоните мне (лучше в телеграмм)!</b></li>
        <li><b>(Только нижегородцы) По любым вопросам, а особенно если что-то идет не так, сразу и в любое время звоните мне (лучше в телеграмм)!</b></li>
        </ul>
        <h3>О чем речь?</h3>
        <p>Школьная олимпиада по информатике в Нижнем Новгороде и Нижегородской области состоится, видимо, <b>25 октября</b>, но обязательно уточните сроки заранее в своей школе. (Школьники не из области — тоже уточняйте у себя в школе).</p>
        ...
        <p>Последние годы менялись организаторы и формат олимпиады, поэтому задачи за старые годы особого смысла смотреть нет. На алгопроге есть задачи позапрошлого года.</p>
...
reg_about = () ->
    page("Про областную (региональную) олимпиаду", String.raw"""<h1>Про областную (региональную) олимпиаду</h1>
        <p><i>(C) Петр Калинин, 2015-22 Этот текст можно свободно распространять на условиях лицензии Creative Commons Attribution-ShareAlike 2.0 (CC-BY-SA). Пожалуйста, при ссылках на этот текст используйте адрес <a href="https://algoprog.ru/material/reg_about">algoprog.ru/material/reg_about</a></i>

        <p><font color="red">Часть информации касается только Нижегородской области, часть относится ко всем регионам.</font></p>

        <p>Областная олимпиада по информатике (формально — региональный этап Всероссийской олимпиады) пройдет в два тура 21 и 23 января.</p>
        ...
        <p>Проходные баллы в этом году 50 баллов по всем классам (да, очень очень низкий проходной балл, из-за того, что задачи районной олимпиады были очень сложными).</p>
        ...
        <p>Раньше после каждого тура у вас был  обед, потом разбор задач и объявление итогов тура. Последние годы эту программу сокращают, но в любом случае я очень вам рекомендую дождаться окончания официальных мероприятий, в частности, если будут оглашать какие-то итоги, выдавать какие-нибудь бумажки с результатами, то дождаться их и проверить, что все подсчитано верно. У нашего жюри регулярно случаются проблемы с подсчетом баллов, поэтому лучше дождитесь и проверьте, что все соответствует вашим ожиданиям. Конечно, вы по идее должны знать свои баллы за счет фидбека, но лучше все-таки дождитесь бумажки.</p>

        <p>Если окажется, что вам неправильно посчитали баллы, то можно попробовать как-то поругаться с жюри. Но если вы уйдете раньше и не получите бумажку с результатами, то ругаться будет сложнее. Конечно, если никакие бумажки вообще не выдают, то ждать бессмысленно.</p>
