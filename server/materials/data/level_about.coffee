...
summerSchools = () ->
    page("Про летние школы", """
        ...
        <p><b><a href="http://lksh.ru">Летняя компьютерная школа (ЛКШ)</a></b> — самая крутая и самая известная. Если можете, обязательно постарайтесь поступить и поехать в нее. 
