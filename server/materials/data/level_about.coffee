...
label_ochn = () ->
    label("""
        ...
        <li>Новичкам (кто не ходил ни разу и не решал задач заочно) 
            ...
            туда можно приходить всем новичкам вообще.</li>
        ...
        <h3>ННГУ</h3>
        <h4>Пока (2021-21 уч. год) занятий в ННГУ нет.</h4>
        <strike><p><b>Только для школьников</b></p>
        <p>Занятия проходят по воскресеньям в ННГУ ил. Лобачевского (пр. Гагарина, 23), корп. 2, ауд. 110 и 114.</p>
