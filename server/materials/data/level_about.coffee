...
module20927_21 = () ->
    page("\nО бесплатности занятий для нижегородских школьников", """
...
module16024_1 = () ->
    page("Про свои ноутбуки на занятиях", """
...
module20927_9 = () ->
    page("\nИнструкция для тех, кто здесь в первый раз (или \"Что надо сделать, чтобы начать заниматься?\")", """
...
module20927_33 = () ->
    page(" \nПро дополнительные лекции по воскресеньям", """
...
pay = () ->
    page("Стоимость и порядок оплаты занятий", """
...
module20927_13 = () ->
    page("\nПро засчитывание и игнорирование решений", """
...
sis = () ->
    page("Про Летнюю компьютерную школу", """
...
module16024_11 = () ->
    page("Про Нижегородскую городскую олимпиаду им. В.Д. Лелюха", """
...
module20927_11 = () ->
    page("\nРабота с сайтом, отправка решений и просмотр моих комментариев", """
...
module20927_7 = () ->
    page("FAQ для студентов и старше", """
...
module16024_7 = () ->
    page("Про районную/городскую олимпиаду", """
...
module20927_5 = () ->
    page("FAQ для школьников", """
        ...
        <p>Единственное — во время праздников или летом у меня может быть ограничен доступ к интернету, поэтому я могу не так быстро отвечать на ваши письма, смотреть ваши решения и т.д. (Хотя стараюсь отвечать в теченик суток, в крайних случаях — в течение 2-3 дней.)</p>
...
module20927_17 = () ->
    page("\nПро очные занятия для школьников", """
...
module20927_29 = () ->
    page("\nФормулы расчета рейтинга, активности и т.д.", """
