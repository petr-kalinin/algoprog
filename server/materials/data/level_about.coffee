...
module20927_17_ochn_high = () ->
    page("\nПро очные занятия для старших уровней ", String.raw"""
        ...
        <p>Для старших уровней (примерно уровень 3 и выше, но см. еще следующий абзац) по воскресеньям проводятся дополнительные занятия. Сейчас (сентябрь 2020 г.) пока очных занятий нет, 
        дополнительные занятия проводятся в дистанционном режиме. А именно, я заранее готовлю некоторый контест (обычно — какой-нибудь старый div2-раунд с codeforces), вы его заранее 
