...
summerSchools = () ->
    page("Про летние школы", String.raw"""
        ...
        Всем, у кого уровень хотя бы 1Г, имеет смысл попробовать попать хотя бы в одну из них. 
        (Не надо гнаться за кучей школ; вполне достаточно съездить в какую-нибудь одну, максимум две.)</p>

        <p>В этом году в связи с короновирусом возможны различные изменения и вариации в формате проведения школ; следите за их сайтами и другими источниками информации.</p>
        ...
        <p><b><a href="https://www.sicamp.ru/">Летний компьютерный лагерь (ЛКЛ)</a></b> — отдельная школа, но по сути сделанная по образцу и подобию ЛКШ, и уже давно считается эдаким «младишим братом» ЛКШ. 
        Правда, на сайте школы почему-то пока информация только прошлого года.</p>

        <p><b><a href="https://vk.com/oisch">Летняя школа олимпиадной подготовки в Иннополисе</a></b></p>
        
        <p><b><a href="https://cs.hse.ru/csss/2020/">Летняя школа по компьютерным наукам</a></b></p>

        <p>И отдельно упомяну так называемую Летнюю компьютерную школу Volga Camp (<a href="https://volgacamp.ru/">сайт</a>). <b>Это обман!</b> Люди пытаются паразитировать
