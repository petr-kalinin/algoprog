...
pay = () ->
    page("Стоимость и порядок оплаты занятий", String.raw"""
        ...
        <p>Конечно, в любом случае вместо возврата денег я могу просто продлить оплаченный период на срок, соответствующий сумме возврата.</p>
        </div>
    """, {id: "pay"})
...
module20927_17 = () ->
    page("\nПро очные занятия для школьников", String.raw"""
        ...
        <p>Занятия проходят <b>по средам в КЦ</b>. Я обычно бываю в лицее с 14.30 до 17.00, иногда чуть позже. Можно приходить и уходить в любое время, но см. ниже про нехватку компьютеров.</p>
...
label_ochn = () ->
    label("""
        ...
        <p>Занятия проходят по средам в <b>14:30</b> в КЦ.</p>
        <ul>
