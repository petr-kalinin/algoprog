...
export default loops = () ->
    return {
        ...
        [label(ruen(
                   String.raw"""<a href="https://notes.algoprog.ru/python_basics/2_loops.html">Питон: теория про циклы</a><br>
                ...
                Прочитайте его, даже если вы пишете не на питоне, в других языках все аналогично.""",
                   String.raw"""<a href="https://notes.algoprog.ru/python_basics/2_loops.html">Python: the theory of cycles</a><br>
                Inside the theory about cycles there is also a section <a href="https://notes.algoprog.ru/python_basics/2_loops.html#break-continue">about the break and continue commands</a>.
