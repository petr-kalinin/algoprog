...
export default bit_operations = () ->
    return {
        topic: topic(
            ruen("Битовые операции", "Bitwise operations"),
            ruen("Задачи на битовые операции", "Problems on bitwise operations"),
        [label(ruen("""<p>Теория: <a href='https://notes.algoprog.ru/shortideas/03_5_bitandor.html'>основная</a>, дополнительно:
            ...
            """<p>Theory: <a href='https://en.wikipedia.org/wiki/Bitwise_operation'>one</a>, <a href='https://code.tutsplus.com/articles/understanding-bitwise-operators--active-11301'>two</a>, <a href='https://www.baeldung.com/java-bitwise-operators'>three</a>.
