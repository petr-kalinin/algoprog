...
module24698 = () ->
    page("Про язык C++", String.raw"""
        ...
        <p>Посмотрите "хорошие решения" на уровне 1 — там почти по каждой задаче есть "хорошее решение" на C++, а то и несколько; думаю, даже по ним можно выучить основы синтаксиса.</p>
