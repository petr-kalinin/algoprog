...
export default matching = () ->
    return {
        topic: topic(
            ruen("Паросочетания и связанные темы", "Matchmaking and related topics"),
            ruen("Задачи на паросочетания", "Problems on matchmaking"),
        [label(ruen(
