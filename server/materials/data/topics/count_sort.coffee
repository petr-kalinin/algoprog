...
export default count_sort = () ->
    return {
        topic: topic(
            ruen("Сортировка подсчетом", "Sorting by counting"),
            ruen("Задачи на сортировку подсчетом", "Problems on sorting by counting"),
        [label(ruen(
             ...
             "See video <a href=\"https://sis.khashaev.ru/2013/august/c-prime/Prz7x1bkW5Y/\">recordings of lectures of the Parallel C LCS'</a><br>\nSee the videos of lectures of the LCS parallel B' (old): <a href=\"https://sis.khashaev.ru/2008/august/b-prime/kVcmMxhr-CI/\">one</a> and <a href=\"https://sis.khashaev.ru/2008/august/b-prime/mkdwnjYkg-g/\">two</a><br>\nSee video <a href=\"https://sis.khashaev.ru/2013/july/b-prime/X27QTFl70lY/\">recordings of lectures of the Parallel B' (new) LCS</a>")),
            label(ruen(
                ...
                "Unfortunately, the set of tasks below is not very representative, but there are no more interesting tasks for sorting by counting in computer science.")),
            problem(111759),
            problem(49),
            problem(1027),
        ], "count_sort"),
