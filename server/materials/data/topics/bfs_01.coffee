...
export default bfs_01 = () ->
    return {
        ...
        [label(ruen(
             ...
             "<a href=\"https://sis.khashaev.ru/2013/july/b-prime/vw4U9aCQA2o/\">LKSH videos, 2013, B'</a><br>\n<a href=\"https://sis.khashaev.ru/2008/august/b-prime/ajEpcdbJ-sE/\">LKSH videos, 2008, B'</a> (see this and the following topics, up to \"Repetition: Shortest paths in a 0-1 graph.\")")),
            problem(3376),
            problem(2003),
        ], "bfs_01")
    }