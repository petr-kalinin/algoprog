...
export default segment_tree = () ->
    return {
        topic: topic(
            ruen("Дерево отрезков", "Tree of segments"),
            ruen("Задачи на дерево отрезков", "Problems on tree of segments"),
        [label(ruen(
