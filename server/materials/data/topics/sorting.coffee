...
module16475 = () ->
    page(ruen(
        ...
        <p>Ответ — в переменной <code>inversions</code>. Обратите внимание, что в этом коде есть еще одно отличие от кода сортировки, приведенного выше, и поймите, почему это так.</p></div>"""), {skipTree: true})
