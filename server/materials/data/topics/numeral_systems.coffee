...
export default numeral_systems = () ->
    return {
        ...
        [label(ruen(
             ...
             "There is no theory here yet, you can search on the Internet (I found <a href=\"https://en.wikipedia.org/wiki/Numeral_system\">one</a>, <a href=\"https://www.baeldung.com/cs/numerical-systems\">two</a>). You need an understanding of how positional numeral systems works, and how to translate numbers from one system to another.")),
            problem(117),
            problem(344),
            problem(47),
            problem(1367),
