...
export default advanced_numbers = () ->
    return {
        ...
        [label(ruen(
             ...
             "<p>See the theory on e-maxx: <br>\n<a href=\"https://e-maxx.ru/algo/extended_euclid_algorithm\">extended Euclidean algorithm</a>, <br>\n<a href=\"https://e-maxx.ru/algo/reverse_element\">inverse by simple modulus</a>, <br>\n<a href=\"https://e-maxx.ru/algo/diofant_2_equation\">linear diophantine equations</a>, <br>\n<a href=\"https://e-maxx.ru/algo/diofant_1_equation\">linear equation by modulo</a><br>\n<a href=\"https://e-maxx.ru/algo/chinese_theorem\">Chinese remainder theorem</a>.</p>")),
            problem(3299),
            problem(4188),
            problem(3880),
            problem(1133),
