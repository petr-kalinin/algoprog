...
export default dsu = () ->
    return {
        topic: topic(
            ruen("Системы непересекающихся множеств и минимальный остов", "Systems of disjoint sets and the minimum backbone"),
            ruen("Задачи на СНМ и минимальный остов", "Problems on SNM and minimum frame"),
        [label(ruen(
             ...
             "<p>See the <a href=\"https://sis.khashaev.ru/2013/july/a-prime/\">corresponding lecture of Parallel A'</a><br>\nSee the lectures \"System of disjoint sets (SNM)\" and \"Spanning trees\" from <a href=\"https://sis.khashaev.ru/2008/august/b-prime/\">LKSH.2008.B'</a></p>\n<p>Theory on e-maxx:<br>\n- <a href=\"https://e-maxx.ru/algo/dsu\">A system of disjoint sets</a><br>\n- <a href=\"https://e-maxx.ru/algo/mst_kruskal\">Kraskal 's algorithm</a><br>\n- <a href=\"https://e-maxx.ru/algo/mst_kruskal_with_dsu\">How to make friends with Kraskal and SNM</a><br>\n- <a href=\"https://e-maxx.ru/algo/mst_prim\">Prim 's algorithm</a>\n</p>")),
            problem(3558),
            problem(1362),
            problem(1376),
            problem(185),
