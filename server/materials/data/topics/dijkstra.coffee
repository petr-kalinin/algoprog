...
export default dijkstra = () ->
    return {
        ...
        [label(ruen(
             ...
             "<a href=\"https://sis.khashaev.ru/2008/august/b-prime/\">Lecture about Dijkstra's algorithm in LKSH.2008.B'</a>, see the section \"Dijkstra's algorithm\"<br>\n<a href=\"https://e-maxx.ru/algo/dijkstra\">Theory based on Dijkstra's algorithm on e-maxx</a><br>\n<a href=\"https://sis.khashaev.ru/2013/july/b-prime/\">A lecture on the features of Dijkstra's algorithm in LKSH.2013.B'</a>, see the section \"Short paths in graphs\" (partially; you don't need to use the heap yet)<br>")),
            problem(5),
            problem(6),
            problem(7),
            problem(170),
