...
export default allNews = () ->
    return news([
        newsItem("Деактивация аккаунтов", String.raw"""
            <p>Как всегда, 1 июля я деактивировал почти все аккаунты школьников. Если вы планируете продолжать заниматься, напишите мне, указав класс, в который вы перешли, а также не меняли ли вы школу.</p>
        """),
