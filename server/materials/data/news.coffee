...
export default allNews = () ->
    return news([
        newsItem("Очных занятий до 10 апреля не будет. С 10 апреля планируется возобновление очных занятий.", String.raw"""
            Очных занятий до 10 апреля не будет. Занимайтесь из дома. Если хотите, я готов организовать консультации по zoom, пишите. 
