...
export default allNews = () ->
    return news([
        newsItem("Занятия по подготовке к районной олимпиаде", String.raw"""
            ...
            Ссылка на конференцию в zoom'е: <a href="https://zoom.us/j/91468972747?pwd=SFY3UHB4d1JUVXBUSmgwSE1HTDdLdz09">https://zoom.us/j/91468972747?pwd=SFY3UHB4d1JUVXBUSmgwSE1HTDdLdz09</a> (прошу прощения, что там надо еще как-то регистрироваться,
            это мы не успели согласовать с ВШЭ).</p>
