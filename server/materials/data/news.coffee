...
export default allNews = () ->
    return news([
        newsItem("Смена «Информатика.Регионы» в Сириусе", String.raw"""
            Школьники 7-9 классов (текущего учебного года), обратите внимание на ноябрьскую смену «Информатике.Регионы» в Сириусе. Настоятельно рекомендую попробовать туда поехать.
        """),
