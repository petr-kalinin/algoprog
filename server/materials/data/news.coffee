...
export default allNews = () ->
    return news([
        newsItem("30 декабря состоится Алгопрог — Новый год", String.raw"""
            30 декабря состоится празднование Нового года для нижегородских школьников, занимающихся на алгопроге. Кто хочет принять участие — пишите мне.
        """),
