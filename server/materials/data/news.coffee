...
export default allNews = () ->
    return news([
        ...
        """),
        newsItem("Про занятия в лицее 40", String.raw"""
            <p>Очные занятия в лицее 40 начнутся с 7 октября. Как всегда, в 14.30 в КЦ.</p>
            <p>Очные занятия в ННГУ пока не планируются; скорее всего, в ближайший месяц будут только командные тренировки для участников командной олимпиады. Вообще, возможно, до Нового года очных занятий в ННГУ не будет.</p>
            <p>См. еще новость ниже (старую) про дистанционные занятия.</p>
        """),
