...
export default allNews = () ->
    return news([
        newsItem("23 октября будет школьный этап Всероссийской олимпиады школьников", String.raw"""
            23 октября в Нижегородской области будет школьный этап Всероссийской олимпиады школьников. Рекомендую всем, у кого уровень 1В и выше, участвовать. 
            Я обновил <a href='/material/school_olympiad'>свой текст про школьный этап</a>.
        """),
        
        newsItem("Добавлена информация про командную олимпиаду", String.raw"""
            Добавлена <a href='/material/koshp'>информация про командную олимпиаду</a>.
        """),
