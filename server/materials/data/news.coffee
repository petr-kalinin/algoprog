...
export default allNews = () ->
    return news([
        newsItem("Очные занятия в лицее 40 временно приостанавливаются", String.raw"""
            <p>С 28 сентября очные занятия в лицее 40 не будут проходить. О возобновлении занятий будет объявлено дополнительно.</p>
        """),
