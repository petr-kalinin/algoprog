...
export default allNews = () ->
    return news([
        newsItem("10 февраля занятия в лицее 40 не будет", String.raw"""
            <p>10 февраля занятия в лицее не будет. 17 февраля и далее занятия, скорее всего, будут дальше как обычно.</p>
        """),
