...
export default allNews = () ->
    return news([
        newsItem("Проблемы при взаимодействии алгопрога и информатикса более-менее исправлены", String.raw"""
            <p>Проблемы во взаимодействии алгопрога и информатикса более-менее исправлены, решения, скопившиеся в очереди, протестированы. Сейчас отправка решения на информатикс и получение результатов тестирования может работать дольше чем раньше (до 10-15 минут), я планирую это исправить в течение нескольких дней.</p>
            <p>Платным пользователям оплаченный период продлен на три дня.</p>
        """),
