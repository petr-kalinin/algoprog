...
export default allNews = () ->
    return news([
        newsItem("Наблюдаются проблемы при взаимодействии алгопрога и информатикса", String.raw"""
            <p>На данный момент наблюдаются проблемы во взаимодействии алгопрога и информатикса, в частности, решения не отправляются или отправляются не стабильно.</p>
        """),
