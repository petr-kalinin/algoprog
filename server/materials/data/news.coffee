...
export default allNews = () ->
    return news([
        newsItem("21 апреля — последнее занятие в лицее 40 в этом учебном году", String.raw"""
            28 апреля и далее занятий не будет. Занятия возобновятся в сентябре, следите за объявлениями на сайте.
        """),
