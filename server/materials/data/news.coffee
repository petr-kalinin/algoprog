...
export default allNews = () ->
    return news([
        newsItem("Я декативировал аккаунты в связи с началом нового учебного года", String.raw"""
            Я деактивировал все аккаунты школьников в связи с условным началом нового учебного года (1 июля). 
            Если вы планируете продолжать заниматься, напишите мне, указав школу и класс, где вы будете учиться
