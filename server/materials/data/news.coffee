...
export default allNews = () ->
    return news([
        newsItem("Про проблемы на школьной олимпиаде в Нижегородской области, v2", String.raw"""
            <p>Если ли кто-то так и не сумел нормально написать тур, т.е. не получил непрерывного отрезка времени нужной длительности, в течение которого сайт работал корректно, напишите мне.</p>
        """),
