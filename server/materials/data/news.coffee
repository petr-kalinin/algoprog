...
export default allNews = () ->
    return news([
        newsItem("13 января занятие в лицее 40 будет", String.raw"""
            <p>13 января занятие в лицее 40 будет, и скорее всего занятия будут и дальше по средам, пока все классы учатся очно.</p>
        """),
