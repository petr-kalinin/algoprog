...
export default allNews = () ->
    return news([
        newsItem("Занятий 13 марта во ВШЭ и 16 марта в лицее 40 не будет", String.raw"""
            Занятий 13 марта во ВШЭ и 16 марта в лицее 40 не будет. Занимайтесь из дома. Если хотите, я готов организовать консультации по zoom, пишите. 
