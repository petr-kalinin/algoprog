...
export default allNews = () ->
    return news([
        newsItem("15 сентября занятия в лицее не будет", String.raw"""
            15 сентября занятия в лицее 40 не будет, я буду в Москве. Первое занятие для новичков будет 22 сентября.
        """),
