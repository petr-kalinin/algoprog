...
export default allNews = () ->
    return news([
        newsItem("21-22 ноября ожидаются технические работы", String.raw"""
            <p>21-22 ноября на алгопроге будут проводиться технические работы (перенос алгопрога на другой хостинг). Ожидается недоступность алгопрога в течение нескольких часов, в худшем случае до суток.</p>
        """),
