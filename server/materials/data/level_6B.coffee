...
topic_19484 = () ->
    return topic("Простая геометрия", "6Б: Задачи на простую геометрию", [
        label("<p>См. <a href=\"https://sis.khashaev.ru/2013/july/b-prime/\">видеозаписи лекций ЛКШ.2013.B'</a>, раздел \"Вычислительная геометрия\".<br>\nСм. <a href=\"https://sis.khashaev.ru/2008/august/b-prime/\">видеозаписи лекций ЛКШ.2008.B'</a>, раздел \"Вычислительная геометрия\".</p>"),
        problem(269),
        problem(275),
        problem(436),
        problem(447),
